def prototype_state():
    ...
    state['use_context_gate']=False
    #########################################
    state['use_previous_target_word_for_context_gate']=True
    state['use_decoding_state_for_context_gate']=True
    state['use_current_context_for_context_gate']=True
