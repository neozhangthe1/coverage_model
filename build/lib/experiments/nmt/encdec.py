...
class RecurrentLayerWithSearch(Layer):
    ...
    def __init__(self, rng,
        ...
        # added by Zhaopeng Tu, 2015-11-12
        if type(coverage_activation) is str or type(coverage_activation) is str:
            coverage_activation = eval(coverage_activation)
        if type(coverage_gater_activation) is str or type(coverage_gater_activation) is str:
            coverage_gater_activation = eval(coverage_gater_activation)
        if type(coverage_reseter_activation) is str or type(coverage_reseter_activation) is str:
